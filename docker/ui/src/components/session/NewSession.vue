    ...
    <div
      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div class="flex justify-center mb-16">
          <img class="h-48 w-48" src="/img/logos/opencspm-mark-on-light.svg" alt="OpenCSPM" />
        </div>
        <div class="text-center">
          <h2 class="mt-6 text-3xl leading-9 font-extrabold text-gray-900">
            Open<span class="tracking-tighter border-b-2 border-yellow-300">CSPM</span>
          </h2>
          <p class="mt-8 text-sm leading-5 font-medium text-gray-600">
            Sign in with
          </p>
        </div>
              ...
              <div>
                <a :href="`${this.BASE_URL}/auth/google`"
                  ...
                  <button type="button"
                    ...
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 767 617" version="1.1">
            ...
            <div class="mt-6 relative">
              ...
              <div class="relative flex justify-center text-sm leading-5">
                <span class="px-2 bg-white text-gray-500">
                  Or read-only with <span class="font-semibold">demo</span> account
                </span>
              </div>
            </div>
          </div>
