<template>
  <div>
      ...
      <div class="flex justify-between">
        <nav class="hidden sm:flex items-center text-sm leading-5 font-medium">
          <router-link to="/profiles"
            class="text-gray-500 hover:text-gray-700 transition duration-150 ease-in-out">Profiles
          </router-link>
              ...
              <div class="flex items-center justify-between">
                <div class="flex-1 space-y-8">
                  <div class="space-y-8 sm:space-y-0 sm:flex sm:justify-between sm:items-center">
                    <CampaignDropdown v-if="profile" :profile="profile"
    ...
    <ProfileControlsList v-if="profile" :controls="profile.data.attributes.controls"
