            ...
            if non_resource_urls == []
              resource_names.each do |resource_name|
                ...
                verbs.each do |verb|
                  ...
                  supporting_relationship_with_attrs("K8S_ROLE", @asset_name, "K8S_RBAC_RESOURCE", "#{apigroup}/#{resource}", "k8s.io/RbacResource", res_attrs, "k8s", "HAS_RBAC_RULE", rel_attrs, "left")
                end
              end
            else
